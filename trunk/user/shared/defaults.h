...
#define DEF_WLAN_2G_SSID	BOARD_PID "myhome_2.4G_%s"
#define DEF_WLAN_5G_SSID	BOARD_PID "myhome_%s"
#define DEF_WLAN_2G_GSSID	BOARD_PID "myhome_GUEST_%s"
#define DEF_WLAN_5G_GSSID	BOARD_PID "myhome_GUEST_5G_%s"
